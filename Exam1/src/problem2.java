...
class ExamplesBlocks {    
  ...
  boolean testIncreasingHelp(Tester t) {
    return t.checkExpect(this.mt.increasingHelp(this.blueBlock1), this.mt)
        && t.checkExpect(this.list3.increasingHelp(redBlock1), 
            new ConsLoBlock(this.redBlock1, 
                new ConsLoBlock(this.blueBlock1, 
                    new ConsLoBlock(this.redBlock2, this.mt))));
  }
  ...
  boolean testAlternatingHelp(Tester t) {
    return t.checkExpect(this.mt.alternatingHelp(true), true)
        && t.checkExpect(this.mt.alternatingHelp(false), true)
        && t.checkExpect(this.list3.alternatingHelp(false), true)
        && t.checkExpect(this.list3.alternatingHelp(true), false);
  }
}